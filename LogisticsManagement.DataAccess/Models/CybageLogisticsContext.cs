...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Inventor__3214EC07B6A393DA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Orders__3214EC0733A37CB2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderDet__3214EC0712684090");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Resource__3214EC079814DC95");

            entity.Property(e => e.IsAvailable).HasDefaultValue(true);

            entity.HasOne(d => d.User).WithMany(p => p.Resources)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__Resources__UserI__2C3393D0");
        });

        modelBuilder.Entity<ResourceMapping>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Resource__3214EC07A364CBA0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Roles__3214EC07C5898378");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Shipment__3214EC0784A74088");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC0791319912");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D1053408409B93").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserDeta__3214EC0751834E6D");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.UserDetails)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__UserDetai__UserI__1DE57479");

            entity.HasOne(d => d.Warehouse).WithMany(p => p.UserDetails)
                .HasForeignKey(d => d.WarehouseId)
                .HasConstraintName("FK__UserDetai__Wareh__1ED998B2");
        });

        modelBuilder.Entity<Warehouse>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Warehous__3214EC07F50DE2C3");
